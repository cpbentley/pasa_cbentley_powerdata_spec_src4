 ...
 *
 */
public class TechFactory extends
      BOAbstractFactory implements IStringable, ITechFastNodeData, ITechCharTrieTable, ITechCharAggregate, ITechCharColRun, ITechCharColLocale, ITechIntToIntsBuild, ITechIntToBytesRun, ITechIntToIntBuild, ITechIntPowerArray, ITechStringLinker, ITechOrderedIntToIntRun, ITechCharColBuild, ITechSearchTrie, ITechIntToIntsRun, ITechIntToIntsRunBytes, ITechTrieLink, ITechUserTrie, ITechSearchChar, ITechIntToInts, ITechCharTrie {

   private PDCtxA pdc;

   public TechFactory(PDCtxA pdc) {
      super(pdc.getBOC());
      this.pdc = pdc;
   ...
   public ByteObjectManaged getPowerTrieLinkTechDefault(int numTypes) {
      ByteController bc = new ByteController(getBOC());
    ...
    * @return
    */
   public ByteObjectManaged getPowerCharTrieTableTechDefault(ByteObjectManaged trieTech) {
   ...
   public ByteObjectManaged getPowerCharColBuildTechRoot() {
      ...
      ByteController bc = new ByteController(pdc.getBOC(), pdc.getFactory(), bo);
      bc.addAgent(bo);
      return bo;
   }
    ...
    * @return
    */
   public ByteObjectManaged getPowerIntArrayBuildRootTechDef() {
      ByteObjectManaged bo = getPowerIntArrayBuildRoot();
      return bo;
   }
   ...
   public ByteObjectManaged getPowerLinkStringHashtableBuildTechDef() {
      ...
      ByteController bc = new ByteController(boc, pdc.getFactory(), bo);
      bc.addAgent(bo);
      return bo;
   }
